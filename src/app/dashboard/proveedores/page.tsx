    ...
    return (
      <DashboardLayout currentPage="/dashboard/proveedores">
        <div className="text-center py-12">
          ...
          <p className="text-gray-600">No tienes permisos para gestionar proveedores.</p>
        </div>
      </DashboardLayout>
    );
  }
      ...
      <div className="space-y-6">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
          <div>
            ...
            <p className="text-gray-600">Administra y verifica proveedores de servicios médicos</p>
          </div>
                        ...
                        <div className="flex items-center">
                          ...
                          <div className="ml-4">
                            ...
                            {provider.organization_name && (
                              <div className="text-xs text-gray-400">{provider.organization_name}</div>
                            )}
                          </div>
                        </div>
                      </td>
